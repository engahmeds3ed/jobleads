...
class CreateAfterTaxesDeleteTrigger extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared("
CREATE TRIGGER after_taxes_delete
    ...
    BEGIN
	    UPDATE states INNER JOIN (
			...
			WHERE counties.id = OLD.county_id
    ...
    {
        DB::unprepared('DROP TRIGGER `after_taxes_delete`');
    }
}
